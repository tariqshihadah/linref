...
class EventsData:
    ...
    def extend(self, distance: float | tuple | np.ndarray = 0, inplace: bool = False) -> EventsData | None:
        """
    ...
    def shift(self, distance: float | np.ndarray = 0, inplace: bool = False) -> EventsData | None:
        """
